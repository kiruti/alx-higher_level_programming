...
Results must be displayed as they are in the example below
Your code should not be executed when imported
Solution: 2-my_filter_states.py
...
Results must be displayed as they are in the example below
Your code should not be executed when imported
Solution: 3-my_safe_filter_states.py
...
The results must be displayed as they are in the example below
Your code should not be executed when imported
Solution: 7-model_state_fetch_all.py
...
Your code should not be executed when imported
Solution: 8-model_state_fetch_first.py
...
The results must be displayed as they are in the example below
Your code should not be executed when imported
Solution: 9-model_state_filter_a.py
...
Your code should not be executed when imported
Solution: 10-model_state_my_get.py
...
Your code should not be executed when imported
Solution: 11-model_state_insert.py
...
Your code should not be executed when imported
Solution: 12-model_state_update_id_2.py
...
Your script should connect to a MySQL server running on localhost at port 3306
Your code should not be executed when imported
Solution: 13-model_state_delete_a.py
...
Your code should not be executed when imported
Solution: model_city.py, 14-model_city_fetch_by_state.py
...
Your code should not be executed when imported
Solution: relationship_city.py, relationship_state.py, 100-relationship_states_cities.py
